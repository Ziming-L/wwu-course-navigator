...
Get the text from schedule pdf and put it into a JSON file in temporary_data
...
def process_parser_for_schedule():
    ...
    Run the complete logic for parsing the schedule
        ...
        2. Parse it to a dictionary: print schedule if needed
        3. Create a JSON file to store the schedule
    """
